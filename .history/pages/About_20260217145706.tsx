      ...
      <section className="py-24 px-4 md:px-8 bg-gradient-to-b from-white via-blue-50/30 to-white relative overflow-hidden">
        <div className="container mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            {/* Left Side - Image Grid Layout (Exact Match) */}
            <motion.div
            ...
            >
              ...
              <motion.div 
                ...
                className="absolute top-0 left-[35%] w-[55%] h-[45%] rounded-3xl overflow-hidden shadow-2xl z-10"
              >
                <img 
              ...
              <motion.div 
                whileHover={{ scale: 1.03 }}
                className="absolute top-[8%] left-0 w-[45%] h-[85%] rounded-3xl overflow-hidden shadow-2xl z-0"
              >
                <img 
              ...
              <motion.div 
                whileHover={{ scale: 1.03 }}
                className="absolute bottom-0 left-[35%] w-[55%] h-[45%] rounded-3xl overflow-hidden shadow-2xl z-10"
              >
                <img 
              ...
              <div className="absolute top-1/2 left-[35%] transform -translate-x-1/2 -translate-y-1/2 z-20">
                <div className="relative w-28 h-28 md:w-32 md:h-32">
                  ...
                  >
                    ...
                    <text className="text-[8px] fill-blue-600 font-bold uppercase tracking-[0.3em]">
                      <textPath href="#circlePath">
                        • QIntellect • AI Solutions • Innovation • Technology •
                      </textPath>
                    </text>
                  </motion.svg>
                  
                  {/* Center Icon */}
                  <div className="absolute inset-3 md:inset-4 bg-blue-500 rounded-full flex items-center justify-center shadow-xl border-4 border-white">
