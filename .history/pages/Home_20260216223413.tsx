    ...
    <section className="py-32 bg-slate-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.05] pointer-events-none">
         <svg className="w-full h-full" viewBox="0 0 1000 1000">
            <path stroke="currentColor" strokeWidth="0.5" fill="none" d="M100,100 L900,100 L900,900 L100,900 Z" />
            ...
            <circle cx="150" cy="500" r="2" fill="currentColor" />
            <circle cx="500" cy="600" r="2" fill="currentColor" />
            <circle cx="850" cy="700" r="2" fill="currentColor" />
            <line x1="200" y1="200" x2="400" y2="150" stroke="currentColor" strokeWidth="0.5" />
            <line x1="400" y1="150" x2="600" y2="300" stroke="currentColor" strokeWidth="0.5" />
            <line x1="600" y1="300" x2="800" y2="100" stroke="currentColor" strokeWidth="0.5" />
            <line x1="150" y1="500" x2="500" y2="600" stroke="currentColor" strokeWidth="0.5" />
            <line x1="500" y1="600" x2="850" y2="700" stroke="currentColor" strokeWidth="0.5" />
            <line x1="200" y1="200" x2="150" y2="500" stroke="currentColor" strokeWidth="0.5" />
            <line x1="600" y1="300" x2="500" y2="600" stroke="currentColor" strokeWidth="0.5" />
         </svg>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
           ...
           <div className="lg:col-span-12 space-y-12">
              <div className="space-y-6 max-w-2xl px-4 md:px-0 ml-[10%]">
                 <div className="flex items-center space-x-2 text-rose-500">
                    <div className="w-2 h-2 rounded-full bg-current" />
                    <span className="text-[12px] font-black uppercase tracking-[0.4em]">Testimonial</span>
                 </div>
                 <h2 className="text-4xl md:text-6xl font-medium text-slate-900 leading-[1.1] tracking-tighter font-heading">
           ...
           <div className="lg:col-span-8 flex flex-col space-y-16">
              <div className="relative flex items-center h-[500px]">
                 ...
                 <div className="flex space-x-8 overflow-visible translate-x-[5%]">
                    {testimonials.map((t, i) => (
                      <motion.div
                        ...
                        animate={{ 
                           ...
                           x: -activeIndex * (400 + 32)
                        }}
                        className="flex-shrink-0 w-[400px] bg-white p-12 rounded-[2.5rem] shadow-2xl shadow-slate-200 border border-slate-100 flex flex-col justify-between"
                      >
                         <div className="space-y-6">
                            <div className="flex space-x-1">
                               {[1,2,3,4,5].map(s => <StarIcon key={s} className="w-3 h-3 text-orange-500 fill-orange-500" />)}
                            </div>
                         ...
                         <div className="flex items-center justify-between mt-10">
                            <div className="flex items-center space-x-4">
                               <img src={t.avatar} alt={t.name} className="w-12 h-12 rounded-full ring-4 ring-slate-50" />
                               <div>
                                  <h4 className="text-base font-bold text-slate-900">{t.name}</h4>
                                  <p className="text-xs text-slate-400 font-light">{t.role}</p>
                               </div>
                            </div>
                            <Quote className="w-12 h-12 text-orange-500 opacity-80" />
                         </div>
                      </motion.div>
                    ))}
                 </div>
              ...
              {/* Navigation Arrows at bottom left of the cards */}
              <div className="flex space-x-4 ml-[10%]">
                 <button onClick={prev} className="w-12 h-12 rounded-full border border-slate-200 flex items-center justify-center hover:bg-slate-900 hover:text-white transition-all shadow-sm">
                    <ArrowRight className="w-4 h-4 rotate-180" />
                 </button>
                 <button onClick={next} className="w-12 h-12 rounded-full border border-slate-200 flex items-center justify-center hover:bg-slate-900 hover:text-white transition-all shadow-sm">
                    <ArrowRight className="w-4 h-4" />
                 </button>
              </div>
           </div>

           {/* Right Image Overlay - Peeking behind the cards */}
           <div className="lg:col-span-4 mt-[-400px] lg:mt-0 relative">
              <motion.div 
                initial={{ opacity: 0, x: 100 }}
                whileInView={{ opacity: 1, x: 0 }}
                className="rounded-[3rem] overflow-hidden shadow-3xl aspect-[3/4] group border-8 border-white"
              >
                 <img 
                   src="https://images.unsplash.com/photo-1675271591211-126ad94e495d?q=80&w=2070&auto=format&fit=crop" 
                   alt="AI Technology" 
                   className="w-full h-full object-cover grayscale-[20%] group-hover:grayscale-0 transition-all duration-1000 scale-105"
                 />
