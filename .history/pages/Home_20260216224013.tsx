    ...
    <section className="py-32 bg-[#F8F9FB] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-12 relative z-10">
        ...
        <div className="mb-16 ml-[2%]">
           <div className="flex items-center space-x-2 text-[#E11D48] mb-6">
              <div className="w-2.5 h-2.5 rounded-full bg-current" />
              <span className="text-[14px] font-bold uppercase tracking-[0.4em]">Testimonial</span>
           </div>
           <h2 className="text-4xl md:text-6xl font-bold text-slate-900 leading-[1.1] font-heading max-w-3xl">
             Hear what our about customer <br /> say about our AI agency
           </h2>
        </div>

        <div className="relative flex flex-col lg:flex-row items-center justify-between">
           {/* Card Container - With peeking effect */}
           <div className="w-full lg:w-2/3 relative flex items-center h-[520px] overflow-hidden">
              <div className="flex space-x-8 overflow-visible">
                 {testimonials.map((t, i) => (
                    <motion.div
                       ...
                       className="flex-shrink-0 w-[440px] bg-white p-12 rounded-[2.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.03)] border border-slate-100 flex flex-col justify-between"
                    >
                       <div className="space-y-8">
                          <div className="flex space-x-1">
                             {[1,2,3,4,5].map(s => <StarIcon key={s} className="w-4 h-4 text-[#F97316] fill-[#F97316]" />)}
                          </div>
                       ...
                       <div className="flex items-center justify-between mt-12">
                          <div className="flex items-center space-x-4">
                             <img src={t.avatar} alt={t.name} className="w-14 h-14 rounded-full ring-4 ring-slate-50 shadow-sm" />
                             <div>
                                <h4 className="text-lg font-bold text-slate-900">{t.name}</h4>
                                <p className="text-sm text-slate-400 font-medium tracking-wide uppercase">{t.role}</p>
                             </div>
                          </div>
                          <Quote className="w-12 h-12 text-[#F97316] opacity-20" />
                       </div>
                    </motion.div>
                 ))}
              </div>

               {/* Navigation Buttons - Locked to bottom left of card area */}
              <div className="absolute bottom-4 left-0 flex space-x-4">
                  <button onClick={prev} className="w-12 h-12 rounded-full border border-slate-200 flex items-center justify-center hover:bg-slate-900 hover:text-white transition-all bg-white shadow-sm">
                    <ArrowRight className="w-5 h-5 rotate-180" />
                  </button>
                  <button onClick={next} className="w-12 h-12 rounded-full border border-slate-200 flex items-center justify-center hover:bg-slate-900 hover:text-white transition-all bg-white shadow-sm">
                    <ArrowRight className="w-5 h-5" />
                  </button>
              </div>
           </div>

           {/* AI Image - Pixel Perfect Frame from attachment */}
           <div className="hidden lg:block w-[400px] h-[550px] relative mt-[-40px]">
              <div className="absolute inset-0 bg-white rounded-[4rem] shadow-2xl overflow-hidden p-4">
