      ...
      <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="relative z-10 container mx-auto px-4 md:px-8">
            ...
            >
              <div className="inline-flex items-center gap-4 px-8 py-4 bg-blue-600 text-white rounded-full shadow-xl shadow-blue-600/25">
                ...
                <span className="text-blue-100">200+ Happy Clients</span>
              </div>
            </motion.div>
          </div>
        </section>
        ...
        <section className="mb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { name: 'Healthcare', icon: Stethoscope, image: '/images/logo.png', desc: 'Smart systems for hospitals and clinics' },
              { name: 'Finance', icon: Banknote, image: '/images/logo.png', desc: 'Secure solutions for banks and firms' },
              { name: 'Manufacturing', icon: Factory, image: '/images/logo.png', desc: 'Automation for factories and plants' },
              { name: 'Retail', icon: ShoppingBag, image: '/images/logo.png', desc: 'E-commerce and store solutions' },
              { name: 'Logistics', icon: Truck, image: '/images/logo.png', desc: 'Tracking and delivery systems' },
              { name: 'Education', icon: GraduationCap, image: '/images/logo.png', desc: 'Learning platforms and tools' }
            ].map((industry, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 30 }}
