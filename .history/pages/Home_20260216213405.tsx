  ...
  return (
    <div className="bg-transparent text-slate-900 font-light selection:bg-blue-100 selection:text-blue-700 overflow-x-hidden">
      ...
      <section ref={heroRef} className="relative min-h-[95vh] flex flex-col items-center justify-center pt-32 pb-20 overflow-hidden bg-white">
        ...
        {/* Left Social Sidebar */}
        <div className="hidden lg:flex flex-col items-center absolute left-8 top-1/2 -translate-y-1/2 space-y-8 z-20">
          <div className="flex flex-col items-center space-y-12 mb-12">
            <span className="text-[10px] font-bold text-slate-400 -rotate-90 origin-center whitespace-nowrap flex items-center space-x-4">
              <span>Follow Us</span>
          ...
          <div className="flex flex-col space-y-6">
            ...
            <a href="#" className="text-slate-400 hover:text-blue-600 transition-colors"><Linkedin className="w-4 h-4" /></a>
            <a href="#" className="text-slate-400 hover:text-blue-600 transition-colors"><Twitter className="w-4 h-4" /></a>
            <a href="#" className="text-slate-400 hover:text-blue-600 transition-colors"><Instagram className="w-4 h-4" /></a>
          </div>
        </div>

        {/* Right Sidebar Decoration */}
        <div className="hidden lg:flex flex-col items-end absolute right-8 top-1/2 -translate-y-1/2 space-y-20 z-20">
          <div className="text-right space-y-4">
            ...
            <div className="w-12 h-0.5 bg-slate-900 ml-auto" />
          </div>
        ...
        <motion.div 
          ...
          className="container mx-auto px-4 md:px-12 lg:px-24 relative z-10"
        >
          <div className="flex flex-col space-y-16 max-w-7xl">
            ...
            <div className="space-y-6">
              ...
              <motion.div 
                ...
                className="inline-flex items-center space-x-6 px-4 py-2 rounded-full bg-blue-600 text-white shadow-xl shadow-blue-500/20"
              >
                <span className="text-[11px] font-black uppercase tracking-[0.3em]">We&apos;re</span>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                <div className="lg:col-span-12">
                  <motion.h1 
                    ...
                    className="text-6xl md:text-8xl lg:text-[8.5rem] font-medium text-slate-900 tracking-tighter leading-[0.85] font-heading uppercase"
                  >
                    Architecting <br />
                    Global Technical <br />
                    Intelligence.
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
               ...
               <div className="flex flex-col md:flex-row items-start md:items-center space-y-10 md:space-y-0 md:space-x-12">
                  ...
                  <div className="flex items-center space-x-6 cursor-pointer group">
                     <div className="w-16 h-16 rounded-full bg-slate-900 flex items-center justify-center text-white transition-all group-hover:scale-110 shadow-2xl">
               ...
               <div className="flex flex-col space-y-10">
                  ...
                  <div className="flex items-center">
                     <Link to="/contact" className="px-12 py-5 bg-slate-900 text-white rounded-full font-black text-[10px] uppercase tracking-[0.4em] hover:bg-blue-600 transition-all shadow-2xl group flex items-center">
                        Lets Talk
