...
// ========== SERVICE HERO IMAGES (HD Quality) ==========
const serviceHeroImages: Record<string, string> = {
  'artificial-intelligence': 'https://images.unsplash.com/photo-1677442136019-21780ecad995?q=80&w=2832&auto=format&fit=crop',
  'customized-chatbots': 'https://images.unsplash.com/photo-1531746790731-6c087fecd65a?q=80&w=2874&auto=format&fit=crop',
  'ai-customer-representative': 'https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?q=80&w=2940&auto=format&fit=crop',
  'dynamics-365': 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=2815&auto=format&fit=crop',
  'web-development': 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?q=80&w=2872&auto=format&fit=crop',
  'erp-solutions': 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?q=80&w=2870&auto=format&fit=crop',
  'edi-solutions': 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=80&w=2934&auto=format&fit=crop',
  'iot-solutions': 'https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=2870&auto=format&fit=crop'
};

// ========== SERVICE IMAGES (Features, Process, etc.) ==========
const serviceImages: Record<string, { overview: string; features: string[]; cta: string }> = {
  'artificial-intelligence': {
    overview: 'https://images.unsplash.com/photo-1620712943543-bcc4688e7485?q=80&w=2865&auto=format&fit=crop',
    features: [
      'https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?q=80&w=2870&auto=format&fit=crop',
    ...
    cta: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2870&auto=format&fit=crop'
  },
  'customized-chatbots': {
    overview: 'https://images.unsplash.com/photo-1587614382346-4ec70e388b28?q=80&w=2870&auto=format&fit=crop',
    features: [
      ...
      'https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=2870&auto=format&fit=crop'
    ],
  ...
  'ai-customer-representative': {
    ...
    cta: 'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?q=80&w=2870&auto=format&fit=crop'
  },
  'dynamics-365': {
    overview: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2870&auto=format&fit=crop',
    features: [
...
const serviceContent: Record<string, {
  ...
  'customized-chatbots': {
    ...
    chatConversation: [
      { from: 'user', text: 'Hi, I want to check my order status', delay: 0 },
      { from: 'bot', text: 'Hello! I\'d be happy to help you check your order. Could you please provide your order number or the email address used for the purchase?', delay: 1500 },
      { from: 'user', text: 'Order #QI-78542', delay: 3500 },
      { from: 'bot', text: 'Found it! Your order #QI-78542 was shipped yesterday via FedEx. Tracking number: FX784521369. Expected delivery: February 19, 2026. Would you like me to send you a tracking link?', delay: 5500 },
      { from: 'user', text: 'Yes please, and can I change the delivery address?', delay: 8000 },
      { from: 'bot', text: 'I\'ve sent the tracking link to your email. Regarding the address change — since the package is already in transit, I\'ll connect you with our shipping team who can coordinate with FedEx. Please hold for just a moment... 🔄', delay: 10000 }
    ]
  },
  'ai-customer-representative': {
    ...
    chatConversation: [
      { from: 'user', text: 'I want to change my flight to New York', delay: 0 },
      { from: 'bot', text: 'I\'d be happy to help you change your flight! I can see you have a booking for New York on March 5th. What date would you like to change it to?', delay: 1500 },
      { from: 'user', text: 'March 8th, in the morning if possible', delay: 3500 },
      { from: 'bot', text: 'Perfect! I found three morning flights on March 8th: 6:00 AM ($50 change fee), 8:30 AM ($50 change fee), and 10:15 AM (same price, no fee). Which would you prefer?', delay: 5500 },
      { from: 'user', text: 'The 10:15 one please, no extra charge sounds good', delay: 8000 },
      { from: 'bot', text: 'Excellent choice! I\'ve changed your flight to March 8th at 10:15 AM with no additional charge. Your new confirmation number is QI-NY8815. I\'ve sent the updated itinerary to your email. Is there anything else I can help with today?', delay: 10000 }
    ]
  },
  'dynamics-365': {
...
const AnimatedChatDemo: React.FC<{ conversation: { from: 'user' | 'bot'; text: string; delay: number }[] }> = ({ conversation }) => {
  ...
  return (
    ...
    >
      ...
      {/* Messages */}
      <div className="h-96 overflow-hidden p-5 bg-gradient-to-b from-slate-50 to-white">
              ...
              >
                <div className={`flex items-end gap-3 max-w-[85%] ${msg.from === 'user' ? 'flex-row-reverse' : ''}`}>
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 ${
                    msg.from === 'user' ? 'bg-blue-600' : 'bg-gradient-to-br from-slate-100 to-slate-200'
                  }`}>
        ...
        <div className="flex justify-center gap-4">
          <button 
            ...
            className={`w-16 h-16 rounded-full flex items-center justify-center transition-all shadow-lg ${
              isPlaying ? 'bg-gradient-to-br from-blue-500 to-blue-600 shadow-blue-500/30' : 'bg-slate-700 shadow-slate-700/30'
            }`}
          >
...
const ServiceDetail: React.FC = () => {
  ...
  const heroImage = serviceHeroImages[service.id] || serviceHeroImages['artificial-intelligence'];
