      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center pt-32 pb-20 overflow-hidden">
        ...
        <motion.div style={{ y: heroY, opacity: heroOpacity }} className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Right Side - Creative Visual Design */}
            <motion.div 
            ...
            >
              <div className="relative">
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-8">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <span className="text-white/80 text-sm">+7 Services</span>
                    </div>
                    <p className="text-white font-semibold text-lg">Building Tomorrow's Solutions Today</p>
                  </div>
                </motion.div>
                ...
                <motion.div 
                  ...
                  className="absolute -top-6 -right-6 bg-white rounded-2xl shadow-xl p-5 border border-slate-100"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-slate-900">AI Powered</p>
                ...
                <motion.div 
                  ...
                  whileHover={{ scale: 1.05, y: 5 }}
                  className="absolute -bottom-8 -left-8 bg-white rounded-2xl shadow-xl p-5 border border-slate-100"
                >
                  <div className="flex items-center gap-4">
                ...
                <motion.div 
                  ...
                  className="absolute top-1/3 -right-4 space-y-3"
                >
                  {['Web Dev', 'Chatbots', 'ERP'].map((service, i) => (
                    <motion.div
                      key={i}
                      initial={{ opacity: 0, x: 20 }}
                      animate={{ opacity: 1, x: 0 }}
                      ...
                      whileHover={{ x: -5 }}
                      className="px-4 py-2 bg-white/90 backdrop-blur-sm rounded-full shadow-lg border border-slate-100 text-sm font-semibold text-slate-700"
                    >
                      {service}
                    </motion.div>
                  ))}
                ...
                {/* Animated Ring */}
                <div className="absolute -top-10 -left-10 w-32 h-32 border-4 border-blue-200 rounded-full opacity-50" />
                <motion.div 
                  animate={{ rotate: 360 }}
                  transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                  className="absolute -bottom-12 -right-12 w-40 h-40 border-4 border-dashed border-blue-300/50 rounded-full"
                />
                ...
                <motion.div 
                  ...
                  className="absolute top-20 -left-4 w-4 h-4 bg-blue-500 rounded-full shadow-lg shadow-blue-500/50"
                />
                <motion.div 
                  animate={{ scale: [1, 1.2, 1], opacity: [0.5, 1, 0.5] }}
                  transition={{ duration: 2, repeat: Infinity, delay: 0.5 }}
                  className="absolute bottom-32 right-8 w-3 h-3 bg-emerald-500 rounded-full shadow-lg shadow-emerald-500/50"
                />
              </div>
            </motion.div>
          </div>
