          ...
          <div className="flex flex-col space-y-16 max-w-7xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
               ...
               <div className="flex flex-col space-y-10">
                  ...
                  >
                    From Artificial Intelligence and Customized Chatbots to Dynamics 365, ERP, EDI, Web Development & Mobile Development — QIntellect delivers end-to-end enterprise technology solutions that transform how you operate.
                  </motion.p>
