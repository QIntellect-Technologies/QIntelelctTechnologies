  ...
  return (
    <div className="pt-48 pb-24 bg-white font-light selection:bg-blue-100 selection:text-blue-700">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {SERVICES.map((service, i) => (
            <motion.div 
              ...
              viewport={{ once: true }}
              className="group p-8 bg-white glass-card rounded-3xl border border-white hover:border-blue-300 shadow-xl hover:shadow-3xl hover:-translate-y-3 transition-all duration-700 flex flex-col relative overflow-hidden h-full"
            >
              ...
              <div className="w-14 h-14 bg-blue-600 text-white rounded-2xl flex items-center justify-center mb-8 group-hover:shadow-2xl group-hover:rotate-6 transition-all shadow-xl relative z-10">
                 ...
                 <ul className="space-y-4 mb-8">
                   {service.features.slice(0, 3).map((feat, idx) => (
                     <li key={idx} className="flex items-center text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em]">
                        <div className="w-1.5 h-1.5 rounded-full bg-blue-600 mr-5 shadow-sm" />
                        {feat}
                     </li>
                   ))}
                 </ul>
              ...
              <Link to={`/service/${service.id}`} className="inline-flex items-center justify-between w-full py-4 px-6 rounded-2xl bg-slate-900 text-white hover:bg-blue-600 transition-all font-black text-[10px] uppercase tracking-widest relative z-10 shadow-2xl">
                View Full Blueprint
        ...
        {/* Methodology Section */}
        <div className="mt-48 p-16 md:p-32 rounded-[5rem] bg-slate-900 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row gap-32 items-center">
            ...
            <div className="lg:w-1/2">
              <div className="relative rounded-[4rem] overflow-hidden shadow-4xl border-4 border-white/10">
                 <img 
