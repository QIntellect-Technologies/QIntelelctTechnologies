      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="relative min-h-[900px] flex items-center justify-center">
            ...
            {/* Desktop Circular Connection Lines */}
            <div className="hidden lg:block absolute inset-0 pointer-events-none">
              <svg className="w-full h-full" viewBox="0 0 800 800" fill="none">
                {features.map((feature, index) => {
                  // Calculate circular positions for 8 cards
                  ...
                  return (
                    <motion.line
                      ...
                      x2={x}
                      y2={y}
                      stroke={hoveredId === feature.id ? "#2563eb" : "#e2e8f0"}
                      strokeWidth={hoveredId === feature.id ? "3" : "1.5"}
                      strokeOpacity={hoveredId === feature.id ? "1" : "0.3"}
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
              ...
              >
                ...
                <div className="w-full h-full bg-white rounded-[3.7rem] flex flex-col items-center justify-center p-8 text-center space-y-4 relative overflow-hidden">
            ...
            <div className="relative w-full h-full">
              {features.map((feature, index) => {
                ...
                const mobileRadius = 200; // Smaller radius for mobile
                ...
                return (
                  ...
                  >
                    {/* Card */}
                    <div className="w-48 bg-white rounded-2xl border border-slate-100 shadow-lg hover:shadow-2xl hover:border-blue-100 transition-all duration-500 cursor-pointer relative overflow-hidden">
                      {/* Hover Gradient */}
                      ...
                      <div className="relative p-6 text-center space-y-4">
                        ...
                        <div className="flex justify-center">
                          <div className="w-14 h-14 rounded-2xl bg-slate-950 flex items-center justify-center text-white group-hover:bg-blue-600 group-hover:rotate-12 transition-all duration-500 shadow-lg">
                            <feature.icon className="w-7 h-7" />
                          </div>
                        </div>
                        
                        {/* Title */}
                        <h3 className="text-lg font-semibold font-heading tracking-tight group-hover:text-blue-600 transition-colors text-slate-900 leading-tight">
                          {feature.title}
                        </h3>
                        ...
                        {/* Decorative Dot */}
                        <div className="flex justify-center">
                          <div className="w-2 h-2 rounded-full bg-slate-200 group-hover:bg-blue-500 transition-colors duration-300" />
                        </div>
                      </div>
                    </div>
                  </motion.div>
            ...
            <div className="block lg:hidden relative z-10 mt-20">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
                {features.map((feature, index) => (
                  <motion.div
                    ...
                    className="bg-white p-6 rounded-2xl border border-slate-100 shadow-lg hover:shadow-xl transition-all duration-300"
                  >
                    <div className="flex items-start gap-4">
                      <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-slate-950 flex items-center justify-center text-white">
                        <feature.icon className="w-6 h-6" />
                      </div>
                      <div className="space-y-2">
                        <h3 className="text-lg font-semibold font-heading text-slate-900">{feature.title}</h3>
