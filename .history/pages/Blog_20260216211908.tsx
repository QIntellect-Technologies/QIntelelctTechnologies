          ...
          <AnimatePresence mode='popLayout'>
            {filteredBlogs.map((post, i) => (
              <motion.div
                ...
                className="group flex flex-col h-full bg-white glass-card rounded-3xl border border-slate-100 overflow-hidden shadow-xl hover:shadow-4xl hover:-translate-y-4 transition-all duration-700"
              >
                ...
                <div className="p-8 flex flex-col flex-grow space-y-8">
                  ...
                  <Link 
                    to={`/blog/${post.id}`} 
                    className="inline-flex items-center justify-between w-full p-4 rounded-2xl bg-slate-900 text-white hover:bg-blue-600 transition-all font-black text-[10px] uppercase tracking-widest relative z-10 shadow-2xl mt-4"
                  >
                    Open Blueprint
