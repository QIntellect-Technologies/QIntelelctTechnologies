    ...
    <section className="py-32 bg-[#F8F9FB] relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.4] pointer-events-none">
        <svg className="w-full h-full" viewBox="0 0 1200 800" fill="none">
          {/* Neural dots matching the red color from image */}
      ...
      <div className="container mx-auto px-4 md:px-12 relative z-10">
        {/* Badge and Title - Precise alignment */}
        <div className="mb-12 ml-[2%]">
           <div className="flex items-center space-x-2 text-[#E11D48] mb-4">
        ...
        <div className="relative flex flex-col lg:flex-row items-stretch justify-between gap-8">
           {/* Card Container - Reduced height to match image better */}
           <div className="w-full lg:w-2/3 relative flex items-center h-[480px] overflow-hidden">
              <div className="flex space-x-8 overflow-visible">
                 {testimonials.map((t, i) => (
                    <motion.div
                       ...
                       className="flex-shrink-0 w-[440px] bg-white p-10 rounded-[2.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.03)] border border-slate-100 flex flex-col justify-between h-full"
                    >
                       <div className="space-y-6">
               ...
               {/* Navigation Buttons - Aligned to the bottom left of the grid */}
           ...
           {/* AI Image - Matched height to cards for perfect start/end alignment */}
           <div className="hidden lg:block w-[400px] h-[480px] relative">
              <div className="absolute inset-0 bg-white rounded-[3.5rem] shadow-xl overflow-hidden p-3 border border-slate-50">
