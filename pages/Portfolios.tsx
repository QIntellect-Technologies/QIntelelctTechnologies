        ...
        <section className="mt-48 py-16 bg-slate-900 rounded-2xl text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10 space-y-12">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-8">
              <button className="px-8 py-4 bg-blue-600 text-white rounded-xl font-black hover:bg-blue-700 transition-all shadow-4xl tracking-widest uppercase text-[10px]">Request Strategy Session</button>
