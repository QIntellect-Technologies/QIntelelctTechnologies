  ...
  return (
    <div className="pt-48 pb-24 bg-white font-light selection:bg-blue-100 selection:text-blue-700">
      <div className="container mx-auto px-4 md:px-8">
        ...
        {/* Methodology Section */}
        <div className="mt-48 p-12 md:p-24 rounded-3xl bg-slate-900 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row gap-32 items-center">
            ...
            <div className="lg:w-1/2">
              <div className="relative rounded-3xl overflow-hidden shadow-4xl border-4 border-white/10">
                 <img 
