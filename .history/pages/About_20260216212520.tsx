          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            <div className="lg:w-3/5 space-y-8">
              ...
              <div className="flex flex-wrap gap-12 pt-6">
                <div className="space-y-2">
                  <div className="text-5xl font-medium text-slate-900 tracking-tighter">12Y+</div>
                  <div className="text-[10px] font-bold text-blue-600 uppercase tracking-widest">Industry Leadership</div>
                </div>
                <div className="space-y-2">
                  <div className="text-5xl font-medium text-slate-900 tracking-tighter">500+</div>
            ...
            >
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border-8 border-white group">
                ...
                {/* Overlay Component */}
                <div className="absolute bottom-6 left-6 right-6 p-6 glass-card rounded-2xl border border-white/40">
            ...
            >
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <h2 className="text-4xl font-medium font-heading tracking-tight text-slate-900">Our Mission</h2>
                </div>
                ...
                <div className="grid grid-cols-2 gap-6 pt-2">
                  {[
                    ...
                    <div key={i} className="p-5 bg-slate-50 rounded-2xl border border-slate-100">
                      <div className="text-2xl font-heading font-medium text-blue-600">{stat.val}</div>
              ...
              <div className="space-y-6 pt-8 border-t border-slate-100">
                <div className="flex items-center space-x-4">
                  ...
                  <h2 className="text-4xl font-medium font-heading tracking-tight text-slate-900">Our Vision</h2>
                </div>
                <p className="text-xl text-slate-500 leading-relaxed font-light">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="text-center mb-16 space-y-4">
            ...
            <motion.h2 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              className="text-4xl md:text-7xl font-medium text-white font-heading tracking-tighter leading-tight"
            >
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            <div className="space-y-6">
              ...
              <h2 className="text-4xl md:text-7xl font-medium text-slate-900 tracking-tighter leading-none font-heading">The Path of <br /> Precision.</h2>
            </div>
            <div className="hidden lg:flex items-center space-x-4 p-6 bg-slate-50 rounded-2xl border border-slate-100">
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-32 items-center">
            <div className="lg:w-1/2 space-y-12">
               <div className="space-y-6">
                  ...
                  <h2 className="text-4xl md:text-6xl font-medium text-slate-900 leading-tight tracking-tighter font-heading">Global Minds, <br /> Technical Rigor.</h2>
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                 {TEAM.map((member, i) => (
                   ...
                   >
                     <div className="relative rounded-3xl overflow-hidden mb-6 aspect-[3/4] shadow-xl border-4 border-white">
                       <img 
                        src={member.image} 
                        alt={member.name} 
            ...
            <div className="lg:w-1/2 relative">
               ...
               <motion.div 
                 ...
                 className="absolute -top-12 -right-12 glass-card p-8 rounded-3xl shadow-2xl max-w-sm hidden xl:block border border-white"
               >
                  <Trophy className="w-10 h-10 text-blue-600 mb-6" />
                  <h5 className="text-xl font-medium text-slate-900 font-heading mb-4">Sector Authority</h5>
        ...
        <div className="container mx-auto px-4 md:px-8">
           ...
           >
              ...
              <div className="relative z-10 max-w-4xl mx-auto space-y-12">
                 <h2 className="text-4xl md:text-7xl font-medium font-heading tracking-tighter leading-tight">Become Part of <br /> the Intelligence.</h2>
                 <p className="text-xl text-blue-100 font-light leading-relaxed">Join the global enterprise leaders who rely on QIntellect for technical stability, data sovereignty, and future-proof innovation.</p>
                 <div className="flex flex-col sm:flex-row items-center justify-center gap-6 md:gap-10">
                    <Link to="/contact" className="px-10 py-5 bg-white text-blue-600 rounded-2xl font-black text-xs uppercase tracking-[0.3em] hover:bg-slate-50 transition-all shadow-xl">Book Strategy Session</Link>
                    <Link to="/services" className="px-10 py-5 border-2 border-blue-400 text-white rounded-2xl font-black text-xs uppercase tracking-[0.3em] hover:bg-blue-700 transition-all">Explore Capabilities</Link>
                 </div>
              </div>
           </motion.div>
        </div>
