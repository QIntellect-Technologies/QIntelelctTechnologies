        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <p className="text-lg text-slate-600 leading-relaxed max-w-xl">
              Have a project in mind? We'd love to hear about it. Get in touch with our team and let's create something extraordinary together.
            </p>
            ...
            <div className="space-y-4 pt-6">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-lg font-medium text-slate-900">hello@youragency.com</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-lg font-medium text-slate-900">+1 (647) 555-0172</p>
                </div>
              </motion.div>
            </div>
          </motion.div>
