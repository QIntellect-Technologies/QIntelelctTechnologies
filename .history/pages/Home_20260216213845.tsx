      ...
      <section ref={heroRef} className="relative min-h-[95vh] flex flex-col items-center justify-center pt-32 pb-20 overflow-hidden bg-white">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <motion.div 
            ...
            className="absolute top-1/4 right-[15%] w-64 h-64 bg-blue-500/5 rounded-full blur-3xl" 
          />
          <motion.div 
            animate={{ 
              y: [0, 30, 0],
            ...
            className="absolute bottom-1/4 left-[10%] w-96 h-96 bg-indigo-500/5 rounded-full blur-3xl" 
          />
        </div>
