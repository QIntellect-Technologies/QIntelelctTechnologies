    ...
    <div className="relative flex items-center justify-between mb-24 last:mb-0">
      <div className={`hidden md:block w-1/2 ${isEven ? 'pr-20 text-right' : 'order-last pl-20 text-left'}`}>
        ...
        >
          ...
          <h4 className="text-2xl font-medium text-slate-900 mb-4 font-heading">{title}</h4>
      ...
      <div className={`w-full md:w-1/2 pl-12 md:pl-0 ${!isEven ? 'md:pr-20 md:text-right' : 'md:pl-20 md:text-left'}`}>
        <div className="md:hidden">
          ...
          <h4 className="text-2xl font-medium text-slate-900 mb-2 font-heading">{title}</h4>
        ...
        >
          <div className="w-32 h-32 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center">
            {isEven ? <Box className="w-12 h-12 text-blue-200" /> : <Monitor className="w-12 h-12 text-blue-200" />}
          </div>
        </motion.div>
      </div>
    </div>
...
const About: React.FC = () => {
  ...
  return (
    <div ref={containerRef} className="bg-white font-light selection:bg-blue-100 selection:text-blue-700 overflow-hidden">
      ...
      <section className="relative pt-48 pb-32 px-4 md:px-8 overflow-hidden bg-slate-50">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-20">
            <div className="lg:w-3/5 space-y-12">
              ...
              <motion.h1 
                ...
                className="text-6xl md:text-[9rem] font-medium text-slate-900 font-heading leading-[0.8] tracking-tighter"
              >
                Engineering <br /> 
              ...
              <motion.div 
                ...
                className="space-y-6 text-xl text-slate-500 leading-relaxed font-light max-w-2xl border-l-4 border-blue-600 pl-8"
              >
                <p>
