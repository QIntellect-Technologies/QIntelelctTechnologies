          ...
          <div className="relative">
            ...
            <div className="hidden lg:block relative h-[800px]">
              ...
              {features.map((f, i) => {
                ...
                const x = centerX + Math.cos(radian) * 35; // 35% radius in percentage
                const y = centerY + Math.sin(radian) * 35;
                ...
                return (
                  <motion.div
                    ...
                    className="w-64 bg-white p-6 rounded-2xl border border-slate-100 shadow-lg hover:shadow-2xl hover:border-blue-100 transition-all duration-500 group cursor-pointer z-20"
                  >
                    <div className="flex flex-col items-center text-center space-y-4">
                      <div className={`w-14 h-14 rounded-xl bg-slate-950 flex items-center justify-center text-white group-hover:bg-blue-600 group-hover:rotate-12 transition-all duration-500 shadow-lg`}>
                        <f.icon className="w-7 h-7" />
                      </div>
                      <div className="space-y-2">
                        <h3 className="text-lg font-semibold font-heading tracking-tight group-hover:text-blue-600 transition-colors">{f.title}</h3>
                        <p className="text-sm text-slate-500 leading-relaxed font-light">{f.desc}</p>
                      </div>
                    </div>
                  </motion.div>
              ...
              <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-30">
                <motion.div 
                  initial={{ opacity: 0, scale: 0.8 }}
                  whileInView={{ opacity: 1, scale: 1 }}
                  className="w-72 h-72 rounded-[4rem] bg-gradient-to-br from-blue-600 to-indigo-700 p-2 shadow-[0_0_60px_rgba(37,99,235,0.3)] flex items-center justify-center relative group"
                >
                  ...
                  <div className="w-full h-full bg-white rounded-[3.8rem] flex flex-col items-center justify-center p-10 text-center space-y-6 relative overflow-hidden">
                    ...
                    <motion.div 
                      ...
                      className="w-24 h-24 bg-slate-900 rounded-3xl flex items-center justify-center relative z-10"
                    >
                      <Rocket className="w-12 h-12 text-white" />
                    </motion.div>
                    <div className="relative z-10">
                      <span className="text-sm font-black uppercase tracking-widest text-blue-600">QIntellect</span>
                      <h4 className="text-3xl font-bold font-heading text-slate-900 mt-2">Q-Engine</h4>
                      <p className="text-sm text-slate-600 mt-2">Unified Technology Ecosystem</p>
                    </div>
                  </div>
                </motion.div>
              </div>
