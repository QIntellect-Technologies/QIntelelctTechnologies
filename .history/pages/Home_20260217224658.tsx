           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
              {[
                ...
                { 
                  ...
                  desc: 'AI-powered customer segmentation, personalized marketing automation, and intelligent campaign optimization for maximum engagement.'
                },
                { 
                  ...
                  color: 'text-red-500', 
                  bg: 'bg-red-50', 
                  img: 'https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?q=80&w=2091&auto=format&fit=crop',
                  desc: 'Smart healthcare systems, patient management platforms, and AI-assisted diagnostics for modern medical facilities.'
                },
                { 
                  ...
                  desc: 'Secure fintech solutions, automated trading systems, and compliance-focused ERP integration for financial institutions.'
                },
                { 
                  ...
                  bg: 'bg-indigo-50', 
                  img: 'https://images.unsplash.com/photo-1518432031352-d6fc5c10da5a?q=80&w=1974&auto=format&fit=crop',
                  desc: 'Custom software development, API integrations, and scalable cloud architectures for tech companies and startups.'
                },
                { 
                  ...
                  bg: 'bg-yellow-50', 
                  img: 'https://images.unsplash.com/photo-1523050854058-8df90110c9d1?q=80&w=2070&auto=format&fit=crop',
                  desc: 'Digital learning platforms, student management systems, and AI-powered educational tools for institutions and e-learning.'
                },
                { 
                  ...
                  desc: 'Unified production and retail systems, inventory management, and AI-driven demand forecasting for end-to-end operations.'
                },
                { 
                  ...
                  desc: 'EDI-powered supply chain automation, real-time tracking systems, and predictive logistics optimization.'
                },
                { 
                  ...
                  desc: 'Property management systems, construction project automation, and IoT-enabled smart building solutions.'
                }
              ].map(ind => (
                <motion.div 
                  key={ind.name} 
