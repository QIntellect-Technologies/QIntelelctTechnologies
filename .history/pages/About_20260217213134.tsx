      ...
      <section className="py-24 px-4 md:px-8 bg-slate-900 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-4">
            {[
              { name: 'Artificial Intelligence (AI)', icon: Brain, color: 'from-purple-500 to-purple-600' },
              { name: 'Customized Chatbots', icon: Bot, color: 'from-blue-500 to-blue-600' },
              { name: 'AI Customer Representative', icon: Headphones, color: 'from-green-500 to-green-600' },
              { name: 'Dynamics 365', icon: Settings, color: 'from-orange-500 to-orange-600' },
              { name: 'Web Development', icon: Code, color: 'from-pink-500 to-pink-600' },
              { name: 'EDI Solutions', icon: Database, color: 'from-cyan-500 to-cyan-600' },
              { name: 'ERP Systems', icon: Building, color: 'from-yellow-500 to-yellow-600' }
            ].map((service, i) => (
              <motion.div
                key={i}
