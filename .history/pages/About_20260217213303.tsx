      ...
      <section className="py-24 px-4 md:px-8 bg-slate-900 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-4">
            {[
              { name: 'Artificial Intelligence (AI)', logo: 'https://cdn-icons-png.flaticon.com/512/8637/8637099.png', color: 'from-purple-500 to-purple-600' },
              { name: 'Customized Chatbots', logo: 'https://upload.wikimedia.org/wikipedia/commons/0/04/ChatGPT_logo.svg', color: 'from-blue-500 to-blue-600' },
              { name: 'AI Customer Representative', logo: 'https://cdn-icons-png.flaticon.com/512/4712/4712109.png', color: 'from-green-500 to-green-600' },
              { name: 'Dynamics 365', logo: 'https://logos-world.net/wp-content/uploads/2021/02/Microsoft-Dynamics-365-Logo.png', color: 'from-orange-500 to-orange-600' },
              { name: 'Web Development', logo: 'https://cdn-icons-png.flaticon.com/512/1055/1055687.png', color: 'from-pink-500 to-pink-600' },
              { name: 'EDI Solutions', logo: 'https://cdn-icons-png.flaticon.com/512/2821/2821818.png', color: 'from-cyan-500 to-cyan-600' },
              { name: 'ERP Systems', logo: 'https://cdn-icons-png.flaticon.com/512/3281/3281289.png', color: 'from-yellow-500 to-yellow-600' }
            ].map((service, i) => (
              <motion.div
                key={i}
