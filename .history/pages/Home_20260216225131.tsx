    ...
    <section className="py-24 bg-[#F9FAFB] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
           ...
           {/* AI Image - Modern Animated Design */}
           <div className="lg:col-span-5 hidden lg:block">
              ...
              >
                ...
                <div className="absolute inset-0 rounded-[3rem] bg-gradient-to-br from-[#FF5722] via-[#FF9800] to-[#FFC107] p-[3px] animate-gradient-rotate">
                  <div className="w-full h-full bg-white rounded-[2.85rem] p-3">
                    <div className="relative w-full h-full rounded-[2.5rem] overflow-hidden">
                      ...
                      {/* Gradient Overlay */}
                      <div className="absolute inset-0 bg-gradient-to-t from-[#FF5722]/30 via-transparent to-transparent opacity-60 group-hover:opacity-40 transition-opacity duration-500" />
                      ...
                      {/* Corner Accent */}
                      <div className="absolute top-4 right-4 w-16 h-16 border-t-2 border-r-2 border-white/40 rounded-tr-2xl" />
                      <div className="absolute bottom-4 left-4 w-16 h-16 border-b-2 border-l-2 border-white/40 rounded-bl-2xl" />
                    </div>
                  </div>
                </div>
                ...
                <motion.div 
                  ...
                  className="absolute inset-0 rounded-[3rem] bg-gradient-to-br from-[#FF5722]/20 via-[#FF9800]/20 to-[#FFC107]/20 blur-xl -z-10"
                />
              </motion.div>
           </div>
        </div>
