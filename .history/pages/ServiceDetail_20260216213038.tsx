...
const TechnicalBlueprint = ({ id }: { id: string }) => {
      ...
      >
        ...
        <div className="relative z-10 space-y-8">
          <div className="flex items-center space-x-4">
             ...
             <h3 className="text-3xl font-medium font-heading tracking-tight">Q-Neural Inference Engine</h3>
          </div>
  ...
  if (id === 'web-development') {
    return (
      <motion.div 
        ...
        viewport={{ once: true }}
        className="bg-white border-2 border-dashed border-blue-200 p-8 md:p-10 rounded-3xl shadow-xl relative overflow-hidden"
      >
        <div className="relative z-10 space-y-10">
           <div className="flex justify-between items-start">
              <div className="space-y-2">
                 <h3 className="text-3xl font-medium font-heading tracking-tight text-slate-900">Modern Architecture Stack</h3>
  ...
  if (id === 'erp-solutions' || id === 'dynamics-365') {
    return (
      <motion.div 
        ...
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        className="bg-white border border-slate-200 p-12 rounded-[3.5rem] shadow-xl relative overflow-hidden"
      >
        <div className="relative z-10 space-y-8">
           <div className="flex items-center space-x-4">
  ...
  if (id === 'customized-chatbots' || id === 'ai-customer-representative') {
    return (
      <motion.div 
        ...
        whileInView={{ opacity: 1, x: 0 }}
        viewport={{ once: true }}
        className="bg-white border-2 border-slate-900 p-12 rounded-[3.5rem] shadow-xl relative overflow-hidden"
      >
        <div className="relative z-10 space-y-10">
           <div className="flex items-center space-x-6">
              <div className="w-16 h-16 bg-slate-900 text-white rounded-3xl flex items-center justify-center"><MessageSquare className="w-8 h-8" /></div>
              <div className="space-y-1">
                 <h3 className="text-3xl font-medium font-heading tracking-tight text-slate-900">Conversational Pipeline</h3>
                 <p className="text-[10px] font-mono text-slate-400">Context_Aware_Loop_v9</p>
              </div>
           </div>
           <div className="space-y-6">
              <div className="flex items-center space-x-4">
                 <div className="px-4 py-2 bg-slate-100 rounded-xl text-[10px] font-bold text-slate-500">INPUT</div>
                 ...
                 <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100 text-[10px] font-mono">NATURAL_LANGUAGE_INTENT</div>
              </div>
              <div className="flex items-center space-x-4">
                 <div className="px-4 py-2 bg-slate-100 rounded-xl text-[10px] font-bold text-slate-500">BRAIN</div>
                 <div className="flex-1 h-0.5 bg-slate-100" />
                 <div className="p-6 bg-blue-600 text-white rounded-2xl text-[10px] font-mono shadow-lg">VECTOR_DB_REDUNDANCY</div>
              </div>
              <div className="flex items-center space-x-4">
                 <div className="px-4 py-2 bg-slate-100 rounded-xl text-[10px] font-bold text-slate-500">ACTION</div>
                 <div className="flex-1 h-0.5 bg-slate-100" />
                 <div className="p-6 bg-slate-900 text-white rounded-2xl text-[10px] font-mono">ERP_CRM_TOOL_CALLING</div>
              </div>
           </div>
        </div>
      </motion.div>
  ...
  return <div className="p-12 bg-slate-50 rounded-[3rem] border border-slate-200">Visualization Engine Initializing...</div>;
};
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-24">
            ...
            <div className="lg:w-1/2 relative">
              ...
              >
                <div className="absolute inset-0 bg-blue-600 rounded-[4rem] rotate-3 opacity-5 -z-10" />
                <img 
                  src={techImages[service.id] || `https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=2070&auto=format&fit=crop`} 
                  alt={service.title} 
                  className="rounded-[4rem] shadow-4xl aspect-[4/3] object-cover grayscale-[30%] hover:grayscale-0 transition-all duration-1000"
                />
              </motion.div>
            </div>
          </div>
           ...
           <div className="grid grid-cols-1 lg:grid-cols-12 gap-24">
              ...
              <div className="lg:col-span-5">
                 <div className="sticky top-32 space-y-12">
                    <div className="bg-slate-900 rounded-[3.5rem] p-12 text-white shadow-3xl space-y-12 border border-slate-800">
                       <div className="space-y-4">
                          <h3 className="text-3xl font-medium font-heading tracking-tight">Sovereign Metrics</h3>
                       ...
                       <div className="space-y-8">
                          {[
                            ...
                            <div key={stat.label} className="flex justify-between items-end border-b border-slate-800 pb-4">
                               ...
                               <span className="text-2xl font-medium text-blue-400 font-heading">{stat.value}</span>
                            </div>
                          ))}
                       </div>
                       ...
                       <div className="space-y-6">
                          ...
                          <Link to="/contact" className="block w-full py-6 bg-blue-600 text-white rounded-[2.5rem] text-center text-[11px] font-black uppercase tracking-widest hover:bg-blue-700 transition-all shadow-2xl">
                    ...
                    <motion.div 
                      whileHover={{ scale: 1.02 }}
                      className="p-12 glass-card rounded-[3.5rem] border border-slate-100 flex flex-col items-center text-center space-y-6"
                    >
