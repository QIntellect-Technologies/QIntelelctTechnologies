      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <section className="mb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { name: 'Customer Care & Hospitality', icon: Hotel, image: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?q=80&w=2070&auto=format&fit=crop', desc: 'Guest management and booking systems' },
              ...
              { name: 'Marketing', icon: Megaphone, image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=2015&auto=format&fit=crop', desc: 'Campaign management and CRM solutions' },
              { name: 'Finance & Banking', icon: Banknote, image: 'https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?q=80&w=2070&auto=format&fit=crop', desc: 'Secure financial systems and solutions' },
              { name: 'Manufacturing & Retail', icon: Factory, image: 'https://images.unsplash.com/photo-1565034946487-077d23d7f4f1?q=80&w=2070&auto=format&fit=crop', desc: 'Automation and e-commerce solutions' },
              ...
              { name: 'Supply Chain', icon: Package, image: 'https://images.unsplash.com/photo-1553413077-190dd305871c?q=80&w=2125&auto=format&fit=crop', desc: 'End-to-end supply chain optimization' },
              { name: 'Technology', icon: Laptop, image: 'https://images.unsplash.com/photo-1518709268805-4e9042af2176?q=80&w=2125&auto=format&fit=crop', desc: 'Software development and IT solutions' },
              { name: 'Real Estate', icon: Home, image: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=2073&auto=format&fit=crop', desc: 'Property management and sales platforms' }
            ].map((industry, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 30 }}
