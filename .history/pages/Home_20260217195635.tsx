...
const WhyChooseUs: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      desc: "Our team includes certified Dynamics 365 consultants, AI researchers, EDI specialists, and full-stack developers with deep industry expertise.",
      icon: Users,
      ...
      <section className="py-24 bg-white/40 backdrop-blur-sm border-y border-white/40">
        <div className="container mx-auto px-4 md:px-8">
           <div className="max-w-4xl mb-16 space-y-4">
              <span className="text-[11px] font-black text-blue-600 uppercase tracking-[0.5em]">QIntellect Services</span>
              <h2 className="text-4xl md:text-7xl font-medium text-slate-900 leading-tight tracking-tighter font-heading">Enterprise-Grade <br /> Solutions.</h2>
           </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {SERVICES.map((s, i) => {
                const colors: Record<string, string> = {
                  ...
                  'erp-solutions': 'text-emerald-600 border-emerald-100 bg-emerald-50/50'
                };
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
              {[
                ...
                { 
                  ...
                  bg: 'bg-green-50', 
                  img: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=2053&auto=format&fit=crop',
                  desc: 'AI Customer Representatives for banking, ERP financial modules, and Dynamics 365 Business Central for unified operations.'
                }
              ].map(ind => (
                <motion.div 
                  key={ind.name} 
