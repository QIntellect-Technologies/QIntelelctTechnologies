...
const About: React.FC = () => {
  ...
  return (
    <div ref={containerRef} className="bg-white font-light selection:bg-orange-100 selection:text-orange-700 overflow-hidden">
      ...
      {/* 1. HERO BANNER SECTION - Similar to DigiPlus Design */}
      <section className="relative h-[60vh] md:h-[70vh] flex items-center justify-center overflow-hidden">
        {/* Background Image with AI Theme */}
        <div className="absolute inset-0 bg-cover bg-center bg-no-repeat" 
             style={{ backgroundImage: 'url("/images/ai-background.jpg")' }}>
          {/* Dark Gradient Overlay */}
          <div className="absolute inset-0 bg-gradient-to-br from-slate-900/85 via-slate-800/80 to-orange-900/75" />
          
          {/* AI Network Pattern Overlay */}
          <div className="absolute inset-0 opacity-10">
            <div className="absolute inset-0" style={{
              backgroundImage: 'radial-gradient(circle at 25% 25%, #FF5722 1px, transparent 1px), radial-gradient(circle at 75% 75%, #FFC107 1px, transparent 1px)',
          ...
          <div className="absolute inset-0">
            <motion.div 
              ...
              className="absolute top-1/4 left-1/4 w-2 h-2 bg-orange-400 rounded-full blur-sm opacity-60"
            />
            <motion.div 
              animate={{ 
                x: [20, -20, 20],
              ...
              className="absolute top-3/4 right-1/3 w-3 h-3 bg-orange-300 rounded-full blur-sm opacity-40"
            />
            <motion.div 
              animate={{ 
                x: [-15, 15, -15],
              ...
              className="absolute top-1/2 right-1/4 w-1.5 h-1.5 bg-orange-500 rounded-full blur-sm opacity-50"
            />
          </div>
        </div>
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          >
            Pioneering the future of intelligent technology solutions with cutting-edge AI innovation
          </motion.p>

          {/* Decorative AI Circuit Elements */}
          <motion.div 
            initial={{ opacity: 0, scale: 0.8 }}
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -top-1 left-8 w-3 h-3 bg-orange-500 rounded-full pulse-animation" />
              <div className="absolute -top-0.5 left-14 w-2 h-2 bg-orange-300 rounded-full pulse-animation" style={{ animationDelay: '0.5s' }} />
            </div>
          </motion.div>
        </div>
