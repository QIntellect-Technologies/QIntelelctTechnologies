                ...
                <div key={ind.id} className={`flex flex-col lg:flex-row gap-16 items-center ${i % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}>
                   ...
                   >
                      ...
                      <div className="p-5 bg-blue-600 text-white rounded-2xl shadow-2xl flex items-center justify-between group cursor-default">
                         <div className="space-y-1">
                            <span className="text-[9px] font-black uppercase tracking-widest text-blue-200">Sector Performance</span>
                            <h5 className="text-xl font-medium font-heading">{ind.stats.label}</h5>
                         </div>
                         <div className="text-4xl font-medium font-heading tracking-tighter group-hover:scale-110 transition-transform">{ind.stats.value}</div>
                      </div>
                   </motion.div>
                   ...
                   <div className="lg:w-1/2 space-y-8">
                      <div className="space-y-4">
                         <span className="text-[10px] font-black text-blue-600 uppercase tracking-[0.5em]">{ind.tagline}</span>
                         <h2 className="text-3xl md:text-5xl font-medium text-slate-900 font-heading tracking-tighter leading-tight">{ind.title}</h2>
                         <p className="text-lg text-slate-500 font-light leading-relaxed">{ind.desc}</p>
                      </div>

                      <div className="space-y-4 pt-4">
                         <h4 className="text-[9px] font-black text-slate-400 uppercase tracking-[0.4em]">Integrated Workstreams</h4>
                      ...
                      <div className="pt-6">
                         <Link to="/contact" className="inline-flex items-center px-8 py-4 bg-slate-900 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-blue-600 transition-all shadow-xl group">
                            Request Industry Roadmap <ChevronRight className="w-4 h-4 ml-3 group-hover:translate-x-2 transition-transform" />
                         </Link>
                      </div>
                   </div>
