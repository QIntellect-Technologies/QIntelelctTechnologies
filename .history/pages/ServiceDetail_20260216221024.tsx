  ...
  if (id === 'iot-solutions') {
    return (
      <motion.div 
        ...
        viewport={{ once: true }}
        className="bg-slate-900 text-white p-8 md:p-10 rounded-2xl shadow-2xl overflow-hidden relative border border-slate-800"
      >
  ...
  if (id === 'erp-solutions' || id === 'dynamics-365') {
    return (
      <motion.div 
        ...
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        className="bg-white border border-slate-200 p-8 md:p-10 rounded-2xl shadow-xl relative overflow-hidden"
      >
        <div className="relative z-10 space-y-8">
           <div className="flex items-center space-x-4">
           ...
           <div className="flex flex-col space-y-4">
              {['Finance & Operations', 'Supply Chain Logic', 'Customer Intelligence', 'Legacy Data Bridge'].map((module, i) => (
                <motion.div 
                  ...
                  className="flex items-center justify-between p-6 bg-slate-50 rounded-xl border border-slate-100 group hover:bg-slate-900 hover:text-white transition-all cursor-pointer"
                >
                   <div className="flex items-center space-x-4">
        ...
        <div className="relative z-10 space-y-10">
           ...
           <div className="flex items-center justify-between">
              ...
              <div className="flex-1 px-8">
                 <div className="p-8 bg-blue-600 rounded-2xl text-center shadow-[0_0_50px_rgba(37,99,235,0.4)]">
