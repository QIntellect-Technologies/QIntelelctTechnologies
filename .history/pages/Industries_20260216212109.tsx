...
const IndustryBlueprint = ({ type }: { type: string }) => {
  ...
  switch (type) {
    case 'healthcare':
      return (
        <div className="relative h-48 bg-blue-600 rounded-3xl overflow-hidden p-5 shadow-2xl border border-blue-400">
    ...
    case 'automotive':
      return (
        <div className="relative h-48 bg-slate-900 rounded-3xl overflow-hidden p-5 shadow-2xl border border-slate-700">
    ...
    case 'ecommerce':
      return (
        <div className="relative h-48 bg-white border-2 border-dashed border-blue-200 rounded-3xl overflow-hidden p-5 shadow-xl">
    ...
    default:
      return (
        <div className="relative h-48 bg-slate-50 rounded-3xl overflow-hidden p-5 border border-slate-100">
