          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              >
                ...
                <div>
                  <div className="text-lg font-bold text-slate-900">12+ Years of Building</div>
        ...
        <div className="container mx-auto relative z-10">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight font-heading mb-6">
              How Our <span className="bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">IT Solutions</span> Work
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
            {[
              { 
                ...
                desc: 'We analyze your business needs, challenges, and goals to create a tailored solution strategy.',
                icon: Target
              },
              { 
                step: '02', 
                title: 'Solution Design', 
                desc: 'Our experts design a comprehensive architecture using cutting-edge AI and enterprise technologies.',
                icon: Layers
              },
              { 
                step: '03', 
                title: 'Development & Integration', 
                desc: 'We build and integrate solutions seamlessly with your existing systems and workflows.',
                icon: Cpu
              },
              { 
                step: '04', 
                title: 'Deploy & Support', 
                desc: 'Launch with confidence backed by our 24/7 support and continuous optimization.',
                icon: Shield
              }
            ].map((item, i) => (
              <motion.div
          ...
          >
            ...
            <p className="text-slate-400">Comprehensive IT services tailored for your business growth</p>
          </motion.div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
            ...
            >
              ...
              >
                <motion.span 
                  ...
                  className="w-3 h-3 bg-blue-500 rounded-full"
                />
                <span>The Lineage of Innovation</span>
              </motion.span>
            ...
            >
              ...
              <div>
                ...
                <div className="text-sm text-slate-500 font-medium uppercase tracking-wider">Of Technical Mastery</div>
              </div>
            </motion.div>
          </div>
