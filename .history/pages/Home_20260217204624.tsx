...
const FeatureEcosystem: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Native iOS and Android applications with cross-platform frameworks, real-time sync, and enterprise-grade security.",
      icon: Smartphone,
      side: "left",
      color: "green"
    },
    {
      ...
      desc: "Enterprise resource planning with advanced manufacturing, financials, and supply chain management for large-scale operations.",
      icon: Server,
      side: "left",
      color: "blue"
    },
    ...
    },
    {
      id: "crm",
      title: "CRM Solutions",
      desc: "Customer relationship management platforms with sales automation, lead tracking, and integrated communication tools.",
      icon: Building2,
      side: "right",
      color: "purple"
    },
          ...
          <div className="hidden lg:block absolute inset-0 pointer-events-none">
             <svg className="w-full h-full" viewBox="0 0 1000 600" fill="none">
                ...
                {features.map((f, i) => {
                   ...
                   const sideIndex = isLeft ? leftFeatures.findIndex(feature => feature.id === f.id) : rightFeatures.findIndex(feature => feature.id === f.id);
                   const sideCount = isLeft ? leftFeatures.length : rightFeatures.length;
                   
                   // Dynamic spacing based on number of items per side
                   const spacing = Math.min(120, 500 / Math.max(sideCount - 1, 1));
                   const startY = 300 - ((sideCount - 1) * spacing) / 2;
                   
                   // Points are calibrated for a 1000x600 viewBox
                   const x1 = isLeft ? 400 : 600;
                   const y1 = 300;
                   const x2 = isLeft ? 300 : 700;
                   const y2 = startY + sideIndex * spacing;
