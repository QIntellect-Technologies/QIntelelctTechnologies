          ...
          <AnimatePresence mode="popLayout">
            {filteredProjects.map((project, i) => (
              ...
              >
                ...
                <div className="relative rounded-3xl overflow-hidden aspect-[16/10] shadow-4xl bg-slate-900 border border-slate-100">
                   <img 
                    src={project.image} 
                    alt={project.title} 
                  ...
                  {/* Floating Tech Tag */}
                  <div className="absolute top-6 left-6 p-4 bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/60 flex items-center space-x-4">
                  ...
                  <div className="absolute bottom-6 right-6 flex space-x-4">
                     {project.metrics.map((m, idx) => (
                       <div key={idx} className="p-4 bg-slate-900/80 backdrop-blur-xl rounded-3xl border border-white/10 text-white shadow-2xl">
