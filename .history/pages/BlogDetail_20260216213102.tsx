            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-12 pt-12 border-t border-slate-200">
                <div className="flex items-center space-x-6">
                  <div className="w-16 h-16 rounded-3xl bg-slate-200 overflow-hidden ring-4 ring-white shadow-lg">
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-24 items-start">
            ...
            <div className="lg:col-span-8">
              <div className="relative rounded-3xl overflow-hidden shadow-4xl mb-16 border-4 border-white group">
              ...
              <div className="space-y-20 max-w-4xl mx-auto">
                {post.sections.map((section, i) => (
                  ...
                  >
                    ...
                    {section.code && (
                      <div className="rounded-3xl bg-slate-900 p-10 font-mono text-sm text-blue-300 shadow-2xl relative overflow-hidden group">
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-32 space-y-16">
              ...
              {post.technicalSpecs && (
                <div className="bg-slate-900 rounded-[3.5rem] p-12 text-white space-y-10 shadow-3xl border border-slate-800 relative overflow-hidden">
                ...
                <div className="space-y-8">
                  {recentPosts.map(p => (
                    <Link key={p.id} to={`/blog/${p.id}`} className="group block space-y-4">
                      <div className="flex items-center space-x-6 p-4 rounded-3xl hover:bg-slate-50 border border-transparent hover:border-slate-100 transition-all">
              ...
              {/* Newsletter Callout */}
              <div className="p-12 glass-card rounded-[3.5rem] border border-slate-100 text-center space-y-8 relative overflow-hidden group">
                ...
                <div className="relative z-10">
                   <Mail className="w-12 h-12 text-blue-600 group-hover:text-white mx-auto mb-6 transition-colors" />
                   ...
                   <button className="w-full py-4 bg-slate-900 text-white group-hover:bg-white group-hover:text-blue-600 rounded-2xl text-[10px] font-black uppercase tracking-widest mt-10 transition-all shadow-xl">
                     Synchronize Now
                   </button>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 md:px-8 text-center relative z-10">
           <div className="max-w-5xl mx-auto space-y-16">
              ...
              <div className="flex flex-wrap justify-center gap-8">
                 <Link to="/contact" className="px-16 py-8 bg-blue-600 text-white rounded-[2.5rem] font-black text-[11px] uppercase tracking-widest hover:bg-blue-700 transition-all shadow-4xl">Book Technical Audit</Link>
                 <Link to="/services" className="px-16 py-8 border-2 border-slate-700 text-white rounded-[2.5rem] font-black text-[11px] uppercase tracking-widest hover:bg-slate-800 transition-all shadow-4xl">Full Capability Archive</Link>
              </div>
           </div>
        </div>
      </section>
