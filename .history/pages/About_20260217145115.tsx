...
const TypewriterText: React.FC = React.memo(() => {
  ...
  return (
    <span className="relative inline-block text-[#FF5722]">
      ...
      <span className="inline-block w-[3px] h-[0.9em] bg-[#FF5722] ml-1 animate-pulse align-middle" />
    </span>
  );
});
      ...
      <section className="relative h-[70vh] md:h-[80vh] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            className="inline-flex items-center space-x-2 px-4 py-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full mb-6"
          >
            <div className="w-2 h-2 bg-[#FF5722] rounded-full animate-pulse" />
            <span className="text-white/90 text-xs font-medium uppercase tracking-wider">AI Technology Leaders</span>
          </motion.div>
          ...
          <motion.div
            ...
            className="text-xl md:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto font-light"
          >
          ...
          <motion.p
            ...
            className="text-base md:text-lg text-gray-300 max-w-2xl mx-auto leading-relaxed mb-8 font-light"
          >
            Transforming businesses through cutting-edge AI solutions, intelligent automation, 
            and enterprise technology that drives real results.
          </motion.p>
          ...
          >
            ...
            <span className="text-[#FF5722] text-sm font-medium">About</span>
          </motion.nav>
