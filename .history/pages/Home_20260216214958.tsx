...
const HeroNeuralBackground: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const nodes: Node[] = [];
    const pulses: Pulse[] = [];
    const nodeCount = Math.min(Math.floor((width * height) / 35000) + 15, 60); // Lowered node count and capped
          ...
          <div className="flex flex-col lg:flex-row items-center gap-20 xl:gap-32">
            ...
            <div className="lg:w-1/2 relative">
              <motion.div 
                ...
                className="relative rounded-[3rem] overflow-hidden shadow-3xl z-10"
              >
                <img 
              ...
              <motion.div 
                ...
                className="absolute -bottom-8 -right-8 w-32 h-32 bg-white rounded-3xl shadow-2xl border border-slate-100 flex items-center justify-center z-20"
              >
