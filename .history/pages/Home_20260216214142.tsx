        ...
        <div className="container mx-auto px-4 md:px-8">
           <div className="flex flex-col lg:flex-row gap-32 items-center">
              ...
              <div className="lg:w-1/2 relative">
                 <motion.div style={{ y: philImageY }} className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white bg-white">
                 ...
                 <motion.div 
                   style={{ y: philCardY }}
                   className="absolute -bottom-16 -left-16 glass-card p-10 rounded-3xl shadow-2xl space-y-6 max-w-sm hidden xl:block border border-white/60"
                 >
                    <div className="w-14 h-14 bg-blue-600 text-white rounded-xl flex items-center justify-center shadow-xl">
                       <ShieldCheck className="w-7 h-7" />
                    </div>
                    <div className="space-y-3">
                       <h5 className="text-xl font-medium text-slate-900 font-heading">Zero-Risk Sync</h5>
