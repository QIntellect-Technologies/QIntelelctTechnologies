...
const TestimonialSection: React.FC = () => {
  ...
  const testimonials = [
    {
      text: "This AI solution has completely transformed the way our team operates. From automating repetitive tasks to providing smart insights, it's allowed us to focus more on strategy and branded active creativity!",
      name: "Jacob Jones",
      role: "Head of Digital Strategy, NovaTech",
      avatar: "https://i.pravatar.cc/150?u=jacob"
    },
    {
      text: "QIntellect's implementation of LLMs into our workflow was seamless. The precision and speed of their delivery exceeded our enterprise standards by a significant margin.",
      name: "Guy Hawkins",
      role: "CTO, Quantum Global",
    ...
    <section className="py-32 bg-slate-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16 xl:gap-24">
          ...
          <div className="lg:w-3/5 space-y-12">
            <div className="space-y-6">
               <div className="flex items-center space-x-3">
                  ...
                  <span className="text-[11px] font-black text-blue-600 uppercase tracking-[0.4em]">Testimonial</span>
               </div>
               <h2 className="text-4xl md:text-7xl font-medium text-slate-900 leading-tight tracking-tighter font-heading uppercase">
                 Hear what our <br /> <span className="text-blue-600 italic">customers say</span> <br /> about us.
               </h2>
            </div>
            ...
            <div className="relative h-[400px] md:h-[350px]">
               <AnimatePresence mode="wait">
                  <motion.div
                    ...
                    className="absolute inset-0 bg-white p-10 md:p-12 rounded-[2.5rem] shadow-2xl shadow-blue-900/5 border border-slate-100 flex flex-col justify-between"
                  >
                     <div className="space-y-8">
                        <div className="flex space-x-1">
                           {[1,2,3,4,5].map(s => <StarIcon key={s} className="w-4 h-4 text-blue-600 fill-blue-600" />)}
                        </div>
                     ...
                     <div className="flex items-center justify-between mt-8">
                        <div className="flex items-center space-x-4">
                           ...
                           <div>
                              ...
                              <p className="text-sm text-slate-500 font-light">{testimonials[activeIndex].role}</p>
                           </div>
                        </div>
            ...
            <div className="flex space-x-4">
               <button 
                 onClick={prev}
                 className="w-14 h-14 rounded-full border border-slate-200 flex items-center justify-center hover:bg-slate-900 hover:text-white transition-all group shadow-sm hover:shadow-xl"
               >
          ...
          {/* Right: AI Visual */}
          <div className="lg:w-2/5 relative lg:-ml-12 z-0">
             <motion.div 
               initial={{ opacity: 0, x: 50 }}
               whileInView={{ opacity: 1, x: 0 }}
               className="relative rounded-[3rem] overflow-hidden shadow-3xl aspect-[4/5] group"
             >
                <img 
                ...
                <div className="absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-blue-900/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
             </motion.div>
          </div>
