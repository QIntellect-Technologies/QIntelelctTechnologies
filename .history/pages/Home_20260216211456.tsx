          ...
          <div className="flex flex-col items-center text-center space-y-12 max-w-7xl mx-auto">
            ...
            <div className="space-y-8 relative">
              <motion.h1 
                ...
                className="text-5xl md:text-[8.5rem] font-medium text-slate-900 tracking-tighter leading-[0.85] font-heading"
              >
                Architecting <br />
              ...
              <motion.p 
                ...
                className="text-lg md:text-2xl text-slate-500 leading-relaxed max-w-4xl mx-auto font-light"
              >
            ...
            >
              <Link to="/contact" className="w-full sm:w-auto px-16 py-6 bg-blue-600 text-white rounded-2xl font-bold hover:bg-blue-700 transition-all shadow-2xl flex items-center justify-center group relative overflow-hidden">
                <span className="relative z-10 tracking-widest uppercase text-xs">Book Strategy</span>
                <ChevronRight className="w-5 h-5 ml-2 relative z-10 group-hover:translate-x-1 transition-transform" />
              </Link>
              
              <Link to="/services" className="w-full sm:w-auto flex items-center justify-center space-x-4 group text-slate-600 hover:text-blue-600 transition-colors bg-white/60 px-8 py-6 rounded-2xl backdrop-blur-md border border-slate-200">
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 h-auto">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="md:col-span-7 md:row-span-2 group relative overflow-hidden rounded-[3rem] bg-slate-900 text-white p-10 md:p-14 border border-slate-800 shadow-2xl"
              whileHover={{ y: -5 }}
            >
              ...
              <div className="relative z-10 h-full flex flex-col justify-between space-y-12">
                <div className="space-y-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <h3 className="text-3xl md:text-5xl font-medium font-heading tracking-tight">Artificial Intelligence</h3>
                    </div>
                  </div>
                ...
                <Link to="/service/artificial-intelligence" className="inline-flex items-center text-[10px] font-black uppercase tracking-[0.4em] text-blue-400 hover:text-white transition-colors">
                  View Neural Architecture <ChevronRight className="w-4 h-4 ml-2" />
                </Link>
              </div>
            </motion.div>
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="md:col-span-5 group relative overflow-hidden rounded-[3rem] bg-blue-600 text-white p-10 flex flex-col justify-between shadow-2xl shadow-blue-500/20"
              whileHover={{ y: -5 }}
            >
               ...
               <div className="relative z-10 space-y-6">
                 <div className="flex items-center space-x-4">
                    ...
                    <div>
                       ...
                       <h3 className="text-2xl font-medium font-heading">IoT Ecosystems</h3>
                    </div>
                 </div>
               ...
               <div className="relative h-24 mt-4 bg-white/5 rounded-2xl border border-white/10 flex items-center justify-center overflow-hidden">
                  ...
                  <div className="absolute top-2 right-4 text-[8px] font-mono text-blue-200">SIGNAL_STRENGTH: 98%</div>
               </div>
            </motion.div>

            {/* D365 / ERP - Data Cards */}
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="md:col-span-4 group relative overflow-hidden rounded-[3rem] bg-white border border-slate-100 p-8 shadow-xl hover:-translate-y-2 transition-transform">
               <div className="space-y-6">
                 <div className="flex items-center space-x-4">
                    ...
                    <h3 className="text-xl font-bold font-heading text-slate-900">Dynamics 365</h3>
                 </div>
                 ...
                 <Link to="/service/dynamics-365" className="inline-flex items-center text-[9px] font-black uppercase tracking-widest text-blue-600">
                    Module Archive <ArrowRight className="w-4 h-4 ml-2" />
                 </Link>
               </div>
            </motion.div>

            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="md:col-span-4 group relative overflow-hidden rounded-[3rem] bg-white border border-slate-100 p-8 shadow-xl hover:-translate-y-2 transition-transform">
               <div className="space-y-6">
                 <div className="flex items-center space-x-4">
                    <div className="w-10 h-10 bg-slate-50 rounded-xl flex items-center justify-center text-slate-900 border border-slate-100">
                       <Database className="w-5 h-5" />
                    </div>
                    <h3 className="text-xl font-bold font-heading text-slate-900">Enterprise ERP</h3>
                 </div>
                 <p className="text-xs text-slate-500 leading-relaxed font-light">
                 ...
                 <div className="flex items-center space-x-3">
                    ...
                    <span className="text-[9px] font-mono text-slate-400">DATA_MIRROR_ACTIVE</span>
                 </div>
                 <Link to="/service/erp-solutions" className="inline-flex items-center text-[9px] font-black uppercase tracking-widest text-blue-600">
                    ERP Roadmap <ArrowRight className="w-4 h-4 ml-2" />
                 </Link>
               </div>
            </motion.div>

            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="md:col-span-4 group relative overflow-hidden rounded-[3rem] bg-white border border-slate-100 p-8 shadow-xl hover:-translate-y-2 transition-transform">
               <div className="space-y-6">
                 <div className="flex items-center space-x-4">
                    <div className="w-10 h-10 bg-slate-50 rounded-xl flex items-center justify-center text-slate-900 border border-slate-100">
                       <RefreshCw className="w-5 h-5" />
                    </div>
                    <h3 className="text-xl font-bold font-heading text-slate-900">EDI Exchange</h3>
                 </div>
                 <p className="text-xs text-slate-500 leading-relaxed font-light">
                 ...
                 <div className="flex -space-x-2">
                    {[1,2,3].map(i => (
                      <div key={i} className="w-6 h-6 rounded-full border-2 border-white bg-blue-100 text-[8px] flex items-center justify-center font-bold text-blue-600">P{i}</div>
                    ))}
                    <div className="px-2 h-6 rounded-full border-2 border-white bg-slate-100 text-[8px] flex items-center justify-center font-bold text-slate-400">+14 Partners</div>
                 </div>
                 <Link to="/service/edi-solutions" className="inline-flex items-center text-[9px] font-black uppercase tracking-widest text-blue-600">
                    Protocol Docs <ArrowRight className="w-4 h-4 ml-2" />
                 </Link>
               </div>
            </motion.div>
